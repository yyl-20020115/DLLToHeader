...
public struct StringView : IEnumerable<char>
{
    ...
    {
        char ch = str.Length>0 ? str[0] : '\0';
        if(str.Length>0)
        str = str.Remove(0, 1);
        return ch;
    }

    public bool StartsWith(char value) => this.Length>0 && this.First() == value;
    ...
    public override readonly string ToString() => str.ToString();
    public override int GetHashCode()=>str.GetHashCode();
    public override bool Equals([NotNullWhen(true)] object obj)
        => obj is StringView view && str.Equals(view.str, StringComparison.Ordinal);
}
